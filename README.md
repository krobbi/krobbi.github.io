...
app in `generator/` from the root of the repository (`python -m generator`).
The app requires the packages listed in `requirements.txt` installed to run
correctly. The site's content is output to the `out/` directory.
